...
def read_d1(filename_d1):
    ...
    nenergy, nmass, nphi, ntheta, nswp = 32, 8, 16, 4, 27
    ...
    try:
        ...
        val_names = [
            'epoch', 'energy', 'sc_pot', 'eflux', 'magf',
        ...
        # dead = np.reshape(count, [len(time), nmass, nphi, ntheta, nenergy])

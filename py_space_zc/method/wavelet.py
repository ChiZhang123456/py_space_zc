...
# Local imports
from pyrfu.pyrf import calc_fs
...
if __name__ == "__main__":
    ...
    tint = ['2023-12-29T12:15:00','2023-12-29T12:40:00']
    B_high = maven.get_data(tint, 'B')
    Bt = pyrf.norm(B_high['Bmso'])
    inp = Bt
    out = wavelet(inp)
    ax, _, _ = plot.plot_pcolor(None, out.time.data, out.frequency.data,
                                out.data, cscale='log', yscale='log',clim = [1e-2, 1e3])
    plt.show()